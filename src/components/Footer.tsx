        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/profile.php?id=100013342030206" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://tiktok.com/@mkjohn.snr60?_t=ZM-8yQrG1KCN44&R=1"  target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="https://wa.me/254792939417" target="_blank" rel="noopener noreferrer"
                 className="block text-white/80 hover:text-accent transition-colors">
                WhatsApp Message
              </a>
            </div>
